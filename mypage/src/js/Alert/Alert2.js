...
const Alert2 = (props) => {
  return (
    <div>
      <Alert color="primary">
        This is a primary alert with <a href="http://www.naver.com" className="alert-link">an example link</a>. Give it a click if you like.
      </Alert>
      <Alert color="secondary">
        This is a secondary alert with <a href="http://www.google.com" className="alert-link">an example link</a>. Give it a click if you like.
      </Alert>
      <Alert color="success">
